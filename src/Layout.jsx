...
function LayoutInner({ children, currentPageName, user }) {
  ...
  return (
    <div className="bg-red-300 min-h-screen flex">
      <style>{`
        :root {
            ...
            {navItems.map((item) => {
              ...
              return (
                <Link
                  ...
                  onClick={() => setMobileOpen(false)} className="bg-red-900 text-white px-4 py-3 text-sm font-medium rounded-xl flex items-center gap-3 transition-all duration-200 shadow-sm">
