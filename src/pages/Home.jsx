...
export default function Home() {
  ...
  return (
    <div className="min-h-screen">
      {/* Hero Section */}
      <div className="relative overflow-hidden bg-gradient-to-r from-indigo-900 via-blue-900 to-indigo-800 text-white">
        ...
        <div className="relative max-w-6xl mx-auto px-4 py-16 md:py-24">
          <motion.div
            ...
            className="max-w-2xl"
          >
            <div className="inline-flex items-center gap-2 glass-dark rounded-full px-4 py-2 mb-6 text-sm">
            ...
            <div className="flex flex-wrap gap-4">
              <Link
                ...
                className="inline-flex items-center gap-2 bg-white text-indigo-900 font-semibold px-8 py-4 rounded-2xl text-lg hover:bg-gray-50 transition-colors shadow-lg"
              >
                Get Started
              ...
              <a
                ...
                className="inline-flex items-center gap-2 glass-dark border-2 border-white/30 text-white font-semibold px-8 py-4 rounded-2xl text-lg hover:border-white/50 transition-colors"
              >
      ...
      <div className="max-w-7xl mx-auto px-4 py-16">
        <div className="text-center mb-10">
          <motion.div
            initial={{ opacity: 0, y: 20 }}
            animate={{ opacity: 1, y: 0 }}
            className="inline-flex items-center gap-2 glass-card text-indigo-900 font-medium px-4 py-2 rounded-full text-sm mb-4"
          >
            <Sparkles className="w-4 h-4" />
      ...
      <div className="max-w-7xl mx-auto px-4 py-16 md:py-24">
        <div className="text-center mb-12">
          <h2 className="text-3xl md:text-5xl font-bold text-gray-900 mb-3">
            Everything You Need to <span className="text-gradient-indigo">Succeed</span>
          </h2>
      ...
      {/* Stats */}
      <div className="bg-gradient-to-r from-indigo-900 to-blue-900 text-white py-16">
      ...
      {/* CTA Section */}
      <div className="bg-gradient-to-r from-indigo-800 via-blue-800 to-indigo-900 py-16 md:py-20">
        <div className="max-w-4xl mx-auto px-4 text-center">
          ...
          >
            ...
            <Link
            to={createPageUrl("MyIdea")}
            className="inline-flex items-center gap-3 bg-white text-indigo-900 font-semibold px-8 py-4 rounded-full text-lg hover:bg-gray-50 transition-all shadow-lg hover:shadow-xl"
            >
