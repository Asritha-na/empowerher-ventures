...
export default function Home() {
  ...
  return (
    <div className="min-h-screen bg-white">
          ...
          <motion.div
            ...
            <div className="flex flex-wrap gap-4">
              ...
              <a
                ...
                className="inline-flex items-center gap-2 bg-white/10 border-2 border-white/30 text-white font-semibold px-8 py-4 rounded-xl text-lg hover:bg-white/20 transition-all backdrop-blur-sm">
      ...
      <div className="bg-red-300 mx-auto px-4 py-16 max-w-7xl">
      ...
      <div className="max-w-7xl mx-auto px-4 py-16 md:py-24">
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-6">
          ...
          <motion.div
            ...
            className="bg-white border border-gray-200 rounded-2xl p-6 hover:shadow-md hover:border-gray-300 transition-all card-hover">

              <div className={`w-14 h-14 rounded-xl bg-gradient-to-br ${feature.color} flex items-center justify-center text-2xl mb-4 shadow-sm`}>
                {feature.icon}
              </div>
