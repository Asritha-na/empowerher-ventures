    ...
    <div className="min-h-screen flex items-center justify-center p-4" style={{ background: 'linear-gradient(135deg, #A8515B 0%, #DC586D 100%)' }}>
      ...
      <div className="max-w-2xl w-full">
        ...
        <motion.div
          ...
          <p className="bg-rose-300 p-8 text-left rounded-3xl glass-card group transition-all duration-300 border border-white/20 hover:border-pink-300/50 hover:shadow-2xl hover:shadow-pink-500/30 hover:-translate-y-1 disabled:opacity-50">Learn about the app and understand the difference between roles
