  ...
  return (
    <>
      ...
      <motion.div
        ...
        className="fixed bottom-6 left-6 z-50 bg-white rounded-xl shadow-[0_8px_30px_rgba(0,0,0,0.1)] overflow-hidden hidden md:block border border-gray-200"
      >
        <a
          href="tel:1800-123-4567"
          className="flex items-center gap-3 p-4 hover:bg-gray-50 transition-all duration-200 group"
        >
          <div className="w-11 h-11 rounded-lg bg-gradient-to-br from-[#4F46E5] to-[#6366F1] flex items-center justify-center shadow-sm">
      ...
      <motion.div
        ...
        className="fixed bottom-6 right-6 z-50 bg-white rounded-xl shadow-[0_8px_30px_rgba(0,0,0,0.1)] p-3 hidden md:flex items-center gap-2 border border-gray-200"
      >
